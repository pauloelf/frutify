  ...
  return (
    <div className='flex-1 flex flex-col justify-center items-center px-8 py-2'>
      ...
      <p className='text-xl text-emerald-500 font-secondary mb-10'>
        A fruta que você está procurando escorregou para fora do nosso site. <br /> Volte para a{' '}
        <Link href="/collection" className='underline text-emerald-600 hover:text-emerald-300'>Lista de Frutas</Link> e veja se encontra o que deseja!
      </p>
    </div>
  );
}